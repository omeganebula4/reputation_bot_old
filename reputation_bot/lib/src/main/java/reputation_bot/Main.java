...
public class Main {
	...
	public static void main(String[] args) throws LoginException, IOException, InterruptedException {
		...
		CommandHandler commandManager = new CommandHandler(permissionManager, ".r", "ReputationBot", reactionManager,
				expiringReactionMenuHandler);

		JDA jdaBuilder = JDABuilder.createDefault("ODMxNTI3NjI0NjA1Njk2MDcy.YHWicg.Z7byFNOYO3mehevrS829xfTgFGQ")
				.enableIntents(GatewayIntent.GUILD_MEMBERS).setMemberCachePolicy(MemberCachePolicy.ALL)
				.setActivity(Activity.watching("The Rep Economy Grow")).build();
